  ...
  def index
    ...
    array = [
           ...
           "so", "all", "d", "that's", "stop", "amp", "was", "white", "for", "p",
            ...
            "were", "right", "little", "o", "them", "make", "iqvnd", "there", "these","y'all", "lol", "can't",
            "funny", "real", "still", "never", "think", "been", "down", "ever", "today"
         ]
    counter = WordsCounted.count(text, exclude:array)
    @token_counter = counter.token_frequency[1..20]
  end
