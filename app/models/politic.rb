class Politic < Account
 def self.refresh_data
  @tweet_politics = tweets.search("-filter:retweets filter:safe lang:en mayor OR election OR government OR governor OR politician OR senator OR president #blacktwitter",since_id: maximum(:tweet_id))
